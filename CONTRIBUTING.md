...
Thanks for your interest in ficloud-workbench. All forms of contribution are
...
to remove the node_modules directory under ficloud-workbench, and run npm install
